...
| `src/arch/aarch64/` | AArch64 mechanisms: the EL3 monitor (entry, vector table, console, ESR decoder, monitor calls), the PL011 driver, the freestanding `memset`/`memcpy`, and the Secure EL1 entry |
